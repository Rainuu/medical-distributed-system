      ...
      <el-table :data="tableData" border style="width: 100%" max-height="400px">
        ...
        <el-table-column fixed="right" label="操作" min-width="60px" align="center">
          <template slot-scope="scope">
            ...
            <el-button  type="text" size="small" :disabled="scope.row.orderStatus==='1'" icon="el-icon-bank-card" @click="handlePayWithZfb(scope.row)">微信收费</el-button>
          </template>
        </el-table-column>
      </el-table>

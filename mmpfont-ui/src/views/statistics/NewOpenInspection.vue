<template>
  <div>
			...
			<span>
				<el-form :model="form" ref="form" label-width="100px">
					...
					<el-form-item label="结果上传" prop="city">
						<el-button type="primary" style="float: left">点击上传</el-button>
					</el-form-item>
    ...
    <div style="display: flex;">
      ...
      <el-button type="primary" round icon="el-icon-search" @click="resetForm" style="margin: 20px 10px">搜索</el-button>
      <el-button type="primary" round icon="el-icon-refresh" @click="resetForm" style="margin: 20px 10px">重置</el-button>
...
<!--    <div style="border-style: solid;border-color: white"><span>暂无数据</span></div>-->
    <div>
      <el-table
          :data="tableData1"
          style="width: 100%">
